...
class DistribCond(Distrib):
    ...
    #===============================================================================
    def __init__(self,name:str,var:Var,indep:list,tabla=None):
        self.name = name
        self.indep=indep
        self.var=var
...
class JointDistrib(DistribCond):
    ...
    #=================================================================================
    def __init__(self,name:str,variables:list,descomp:list):
        self.name = name
        self.vars = variables
        self.label_to_var = {}
        self.ID=self
    ...
    def to_Frame(self):
        if len(self.vars) > 30:
            print('Tabla demasiado grande... no se puede crear DF')
            return
        else:
            self.ID=None
            dico=self.get_P()
...
class Question():
    ...
    #=================================================================================
    def __init__(self,joint:JointDistrib):
        self.joint = joint
